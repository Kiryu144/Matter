...
import net.andrasia.spigot.core.reflection.ItemStackReflector;
...
public class CustomItem implements IRegistryValue<CustomItem>
{
     ...
     */
    public static final NamespacedKey ITEM_NAME_KEY = new NamespacedKey(Core.getInstance(), "cin");
     ...
     */
    public static final NamespacedKey ITEM_REG_INDEX = new NamespacedKey(Core.getInstance(), "iri");
